...
namespace MedScheduler.Infrastructure.Migrations
{
    ...
    [Migration("20250820005654_AddDoctorAndPatientNavigationsToAppointment")]
    partial class AddDoctorAndPatientNavigationsToAppointment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Appointment", b =>
                {
                    b.HasOne("MedScheduler.Domain.Entities.User", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("MedScheduler.Domain.Entities.User", "Patient")
                        .WithMany()
