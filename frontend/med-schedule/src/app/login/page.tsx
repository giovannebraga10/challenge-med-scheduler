      ...
      <main className=' w-[80%] flex '>
        ...
        <motion.form
          ...
          <div className='w-[35.752rem]'>
            ...
            <input placeholder='nome@example.com' className='w-full rounded-[0.31375rem] outline-0 border-[0.08rem] border-[#D7D7D7] text-[#696969] text-[1.1rem] p-[1.2rem] mt-[0.6875rem] mb-[3.068rem]' />

            <label className='text-[#696969] font-semibold text-[1.2rem]'>
              Senha
            </label>
            <input placeholder='Sua senha' className='w-full rounded-[0.31375rem] outline-0 border-[0.08rem] border-[#D7D7D7] text-[#696969] text-[1.1rem] p-[1.2rem] mt-[0.6875rem]' type='password' />
          </div>
          <div className='mt-[4.324rem] flex justify-between items-center  w-[35.752rem]'>
            ...
            <button className='bg-[#1352F1] text-[1.2rem] font-semibold px-[4.672rem] py-[1rem] rounded-[0.41875rem] cursor-pointer'>
              Login
            </button>
          </div>
        </motion.form>
